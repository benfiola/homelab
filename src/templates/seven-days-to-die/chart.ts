...
export const chart: TemplateChartFn = async (construct, id) => {
  ...
  new TcpRoute(chart, "friends", "sdtd.fiola.dev", 26900, svc, 26900);
  new UdpRoute(chart, "friends", "sdtd.fiola.dev", 26900, svc, 26900);
  new UdpRoute(chart, "friends", "sdtd.fiola.dev", 26901, svc, 26901);
  new UdpRoute(chart, "friends", "sdtd.fiola.dev", 26902, svc, 26902);
