...
export interface KustomizationSpec {
   ...
   *
   * @schema KustomizationSpec#ignoreMissingComponents
   */
...
export interface KustomizationSpecDependsOn {
   ...
   *
   * @schema KustomizationSpecDependsOn#readyExpr
   */
...
export interface KustomizationSpecKubeConfig {
   ...
   * @schema KustomizationSpecKubeConfig#configMapRef
   */
  readonly configMapRef?: KustomizationSpecKubeConfigConfigMapRef;
...
export function toJson_KustomizationSpecKubeConfig(obj: KustomizationSpecKubeConfig | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'configMapRef': toJson_KustomizationSpecKubeConfigConfigMapRef(obj.configMapRef),
 ...
 *
 * @default the `address` for the `generic` provider, or
 * @schema KustomizationSpecKubeConfigConfigMapRef
 */
export interface KustomizationSpecKubeConfigConfigMapRef {
  /**
   * Name of the referent.
   *
   * @schema KustomizationSpecKubeConfigConfigMapRef#name
   */
  readonly name: string;
}

/**
 * Converts an object of type 'KustomizationSpecKubeConfigConfigMapRef' to JSON representation.
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_KustomizationSpecKubeConfigConfigMapRef(obj: KustomizationSpecKubeConfigConfigMapRef | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'name': obj.name,
  };
...
export interface KustomizationV1Beta2SpecKubeConfig {
   ...
   *
   * @default the `address` for the `generic` provider, or
   * @schema KustomizationV1Beta2SpecKubeConfig#configMapRef
   */
  readonly configMapRef?: KustomizationV1Beta2SpecKubeConfigConfigMapRef;
...
export function toJson_KustomizationV1Beta2SpecKubeConfig(obj: KustomizationV1Beta2SpecKubeConfig | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'configMapRef': toJson_KustomizationV1Beta2SpecKubeConfigConfigMapRef(obj.configMapRef),
 ...
 *
 * @default the `address` for the `generic` provider, or
 * @schema KustomizationV1Beta2SpecKubeConfigConfigMapRef
 */
export interface KustomizationV1Beta2SpecKubeConfigConfigMapRef {
  /**
   * Name of the referent.
   *
   * @schema KustomizationV1Beta2SpecKubeConfigConfigMapRef#name
   */
  readonly name: string;
}

/**
 * Converts an object of type 'KustomizationV1Beta2SpecKubeConfigConfigMapRef' to JSON representation.
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_KustomizationV1Beta2SpecKubeConfigConfigMapRef(obj: KustomizationV1Beta2SpecKubeConfigConfigMapRef | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'name': obj.name,
  };
