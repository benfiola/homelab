...
export interface HelmReleaseSpec {
   ...
   *
   * @schema HelmReleaseSpec#commonMetadata
   */
  readonly commonMetadata?: HelmReleaseSpecCommonMetadata;
...
export function toJson_HelmReleaseSpec(obj: HelmReleaseSpec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'commonMetadata': toJson_HelmReleaseSpecCommonMetadata(obj.commonMetadata),
 ...
 * overridden if its key matches a common one.
 *
 * @schema HelmReleaseSpecCommonMetadata
 */
export interface HelmReleaseSpecCommonMetadata {
  /**
   * Annotations to be added to the object's metadata.
   *
   * @schema HelmReleaseSpecCommonMetadata#annotations
   */
   ...
   *
   * @schema HelmReleaseSpecCommonMetadata#labels
   */
  readonly labels?: { [key: string]: string };
}

/**
 * Converts an object of type 'HelmReleaseSpecCommonMetadata' to JSON representation.
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_HelmReleaseSpecCommonMetadata(obj: HelmReleaseSpecCommonMetadata | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
...
export interface HelmReleaseSpecDependsOn {
   ...
   *
   * @schema HelmReleaseSpecDependsOn#readyExpr
   */
  readonly readyExpr?: string;
}
...
export interface HelmReleaseSpecInstall {
   ...
   *
   * @default RemediateOnFailure'.
   * @schema HelmReleaseSpecInstall#strategy
   */
  readonly strategy?: HelmReleaseSpecInstallStrategy;
...
export function toJson_HelmReleaseSpecInstall(obj: HelmReleaseSpecInstall | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'strategy': toJson_HelmReleaseSpecInstallStrategy(obj.strategy),
    'timeout': obj.timeout,
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
...
export interface HelmReleaseSpecKubeConfig {
   ...
   *
   * @default the `address` for the `generic` provider, or
   * @schema HelmReleaseSpecKubeConfig#configMapRef
   */
  readonly configMapRef?: HelmReleaseSpecKubeConfigConfigMapRef;
...
export function toJson_HelmReleaseSpecKubeConfig(obj: HelmReleaseSpecKubeConfig | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'configMapRef': toJson_HelmReleaseSpecKubeConfigConfigMapRef(obj.configMapRef),
...
export interface HelmReleaseSpecUpgrade {
   ...
   *
   * @default RemediateOnFailure'.
   * @schema HelmReleaseSpecUpgrade#strategy
   */
  readonly strategy?: HelmReleaseSpecUpgradeStrategy;
...
export function toJson_HelmReleaseSpecUpgrade(obj: HelmReleaseSpecUpgrade | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'strategy': toJson_HelmReleaseSpecUpgradeStrategy(obj.strategy),
    'timeout': obj.timeout,
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
 ...
 *
 * @default RemediateOnFailure'.
 * @schema HelmReleaseSpecInstallStrategy
 */
export interface HelmReleaseSpecInstallStrategy {
  /**
   * Name of the install strategy.
   *
   * @schema HelmReleaseSpecInstallStrategy#name
   */
  readonly name: HelmReleaseSpecInstallStrategyName;
   ...
   *
   * @default 5m'.
   * @schema HelmReleaseSpecInstallStrategy#retryInterval
   */
  readonly retryInterval?: string;
}

/**
 * Converts an object of type 'HelmReleaseSpecInstallStrategy' to JSON representation.
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_HelmReleaseSpecInstallStrategy(obj: HelmReleaseSpecInstallStrategy | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'name': obj.name,
 ...
 *
 * @default the `address` for the `generic` provider, or
 * @schema HelmReleaseSpecKubeConfigConfigMapRef
 */
export interface HelmReleaseSpecKubeConfigConfigMapRef {
  /**
   * Name of the referent.
   *
   * @schema HelmReleaseSpecKubeConfigConfigMapRef#name
   */
  readonly name: string;
}

/**
 * Converts an object of type 'HelmReleaseSpecKubeConfigConfigMapRef' to JSON representation.
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_HelmReleaseSpecKubeConfigConfigMapRef(obj: HelmReleaseSpecKubeConfigConfigMapRef | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'name': obj.name,
  };
 ...
 *
 * @default RemediateOnFailure'.
 * @schema HelmReleaseSpecUpgradeStrategy
 */
export interface HelmReleaseSpecUpgradeStrategy {
  /**
   * Name of the upgrade strategy.
   *
   * @schema HelmReleaseSpecUpgradeStrategy#name
   */
  readonly name: HelmReleaseSpecUpgradeStrategyName;
   ...
   *
   * @default 5m'.
   * @schema HelmReleaseSpecUpgradeStrategy#retryInterval
   */
  readonly retryInterval?: string;
}

/**
 * Converts an object of type 'HelmReleaseSpecUpgradeStrategy' to JSON representation.
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_HelmReleaseSpecUpgradeStrategy(obj: HelmReleaseSpecUpgradeStrategy | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'name': obj.name,
    'retryInterval': obj.retryInterval,
 ...
 * Name of the install strategy.
 *
 * @schema HelmReleaseSpecInstallStrategyName
 */
export enum HelmReleaseSpecInstallStrategyName {
  /** RemediateOnFailure */
  REMEDIATE_ON_FAILURE = "RemediateOnFailure",
  /** RetryOnFailure */
 ...
 * Name of the upgrade strategy.
 *
 * @schema HelmReleaseSpecUpgradeStrategyName
 */
export enum HelmReleaseSpecUpgradeStrategyName {
  /** RemediateOnFailure */
  REMEDIATE_ON_FAILURE = "RemediateOnFailure",
  /** RetryOnFailure */
  RETRY_ON_FAILURE = "RetryOnFailure",
...
export interface HelmReleaseV2Beta2SpecKubeConfig {
   ...
   *
   * @default the `address` for the `generic` provider, or
   * @schema HelmReleaseV2Beta2SpecKubeConfig#configMapRef
   */
  readonly configMapRef?: HelmReleaseV2Beta2SpecKubeConfigConfigMapRef;
...
export function toJson_HelmReleaseV2Beta2SpecKubeConfig(obj: HelmReleaseV2Beta2SpecKubeConfig | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'configMapRef': toJson_HelmReleaseV2Beta2SpecKubeConfigConfigMapRef(obj.configMapRef),
 ...
 *
 * @default the `address` for the `generic` provider, or
 * @schema HelmReleaseV2Beta2SpecKubeConfigConfigMapRef
 */
export interface HelmReleaseV2Beta2SpecKubeConfigConfigMapRef {
  /**
   * Name of the referent.
   *
   * @schema HelmReleaseV2Beta2SpecKubeConfigConfigMapRef#name
   */
  readonly name: string;
}

/**
 * Converts an object of type 'HelmReleaseV2Beta2SpecKubeConfigConfigMapRef' to JSON representation.
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_HelmReleaseV2Beta2SpecKubeConfigConfigMapRef(obj: HelmReleaseV2Beta2SpecKubeConfigConfigMapRef | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'name': obj.name,
  };
