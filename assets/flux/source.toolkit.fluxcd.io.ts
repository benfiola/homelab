...
export interface BucketSpec {
   ...
   *
   * @schema BucketSpec#serviceAccountName
   */
 ...
 *
 * @schema ExternalArtifact
 */
export class ExternalArtifact extends ApiObject {
  /**
   * Returns the apiVersion and kind for "ExternalArtifact"
   */
  public static readonly GVK: GroupVersionKind = {
    apiVersion: 'source.toolkit.fluxcd.io/v1',
  ...
  /**
   * Renders a Kubernetes manifest for "ExternalArtifact".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: ExternalArtifactProps = {}): any {
    return {
      ...ExternalArtifact.GVK,
      ...toJson_ExternalArtifactProps(props),
    };
  }

  /**
   * Defines a "ExternalArtifact" API object
   * @param scope the scope in which to define this object
   * @param id a scope-local name for the object
   * @param props initialization props
   */
  public constructor(scope: Construct, id: string, props: ExternalArtifactProps = {}) {
    super(scope, id, {
      ...ExternalArtifact.GVK,
      ...props,
    });
  ...
  public override toJson(): any {
    ...
    return {
      ...ExternalArtifact.GVK,
      ...toJson_ExternalArtifactProps(resolved),
    };
  }
}
 ...
 * @schema ExternalArtifact
 */
export interface ExternalArtifactProps {
  /**
   * @schema ExternalArtifact#metadata
   */
  readonly metadata?: ApiObjectMetadata;
   ...
   *
   * @schema ExternalArtifact#spec
   */
  readonly spec?: ExternalArtifactSpec;
}

/**
 * Converts an object of type 'ExternalArtifactProps' to JSON representation.
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_ExternalArtifactProps(obj: ExternalArtifactProps | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'metadata': obj.metadata,
    'spec': toJson_ExternalArtifactSpec(obj.spec),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * ExternalArtifactSpec defines the desired state of ExternalArtifact
 *
 * @schema ExternalArtifactSpec
 */
export interface ExternalArtifactSpec {
  /**
   * SourceRef points to the Kubernetes custom resource for
   * which the artifact is generated.
   *
   * @schema ExternalArtifactSpec#sourceRef
   */
  readonly sourceRef?: ExternalArtifactSpecSourceRef;
}

/**
 * Converts an object of type 'ExternalArtifactSpec' to JSON representation.
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_ExternalArtifactSpec(obj: ExternalArtifactSpec | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'sourceRef': toJson_ExternalArtifactSpecSourceRef(obj.sourceRef),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * which the artifact is generated.
 *
 * @schema ExternalArtifactSpecSourceRef
 */
export interface ExternalArtifactSpecSourceRef {
  /**
   * API version of the referent, if not specified the Kubernetes preferred version will be used.
   *
   * @schema ExternalArtifactSpecSourceRef#apiVersion
   */
   ...
   *
   * @schema ExternalArtifactSpecSourceRef#kind
   */
   ...
   * Name of the referent.
   *
   * @schema ExternalArtifactSpecSourceRef#name
   */
  readonly name: string;
   ...
   *
   * @schema ExternalArtifactSpecSourceRef#namespace
   */
  readonly namespace?: string;
}

/**
 * Converts an object of type 'ExternalArtifactSpecSourceRef' to JSON representation.
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_ExternalArtifactSpecSourceRef(obj: ExternalArtifactSpecSourceRef | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
...
export interface GitRepositorySpec {
   ...
   *
   * @schema GitRepositorySpec#serviceAccountName
   */
  readonly serviceAccountName?: string;
