...
export interface TenantSpec {
  ...
  /**
   * @schema TenantSpec#certExpiryAlertThreshold
   */
  ...
  /**
   * @schema TenantSpec#poolsMetadata
   */
  readonly poolsMetadata?: TenantSpecPoolsMetadata;
  ...
  /**
   * @schema TenantSpec#prometheusOperatorScrapeMetricsPaths
   */
  readonly prometheusOperatorScrapeMetricsPaths?: string[];
...
export function toJson_TenantSpec(obj: TenantSpec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'certExpiryAlertThreshold': obj.certExpiryAlertThreshold,
    ...
    'poolsMetadata': toJson_TenantSpecPoolsMetadata(obj.poolsMetadata),
    'priorityClassName': obj.priorityClassName,
    'prometheusOperator': obj.prometheusOperator,
    'prometheusOperatorScrapeMetricsPaths': obj.prometheusOperatorScrapeMetricsPaths?.map(y => y),
...
/**
 * @schema TenantSpecPoolsMetadata
 */
export interface TenantSpecPoolsMetadata {
  /**
   * @schema TenantSpecPoolsMetadata#annotations
   */
  readonly annotations?: { [key: string]: string };

  /**
   * @schema TenantSpecPoolsMetadata#labels
   */
  readonly labels?: { [key: string]: string };
}

/**
 * Converts an object of type 'TenantSpecPoolsMetadata' to JSON representation.
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_TenantSpecPoolsMetadata(obj: TenantSpecPoolsMetadata | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'annotations': ((obj.annotations) === undefined) ? undefined : (Object.entries(obj.annotations).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {})),
    'labels': ((obj.labels) === undefined) ? undefined : (Object.entries(obj.labels).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {})),
...
export interface TenantSpecServiceMetadata {
  ...
  /**
   * @schema TenantSpecServiceMetadata#kesServiceAnnotations
   */
  readonly kesServiceAnnotations?: { [key: string]: string };

  /**
   * @schema TenantSpecServiceMetadata#kesServiceLabels
   */
  readonly kesServiceLabels?: { [key: string]: string };
...
export function toJson_TenantSpecServiceMetadata(obj: TenantSpecServiceMetadata | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'kesServiceAnnotations': ((obj.kesServiceAnnotations) === undefined) ? undefined : (Object.entries(obj.kesServiceAnnotations).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {})),
    'kesServiceLabels': ((obj.kesServiceLabels) === undefined) ? undefined : (Object.entries(obj.kesServiceLabels).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {})),
