...
export function toJson_AcceleratorFunctionProps(obj: AcceleratorFunctionProps | undefined): Record<string, any> | undefined {
 ...
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_AcceleratorFunctionSpec(obj: AcceleratorFunctionSpec | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'afuId': obj.afuId,
