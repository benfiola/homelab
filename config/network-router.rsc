...
/interface/wireguard/peers/add allowed-address=192.168.34.5/32 interface=wg-infrastructure name=bfiola-desktop-wsl-infrastructure persistent-keepalive=25s public-key="{{ secrets.wireguard.devices.bfiolaDesktopWsl.infrastructure.public }}"
...
/interface/wireguard/peers/add allowed-address=192.168.89.3/32 interface=wg-management name=bfiola-desktop-linux-management persistent-keepalive=25s public-key="{{ secrets.wireguard.devices.bfiolaDesktopLinux.management.public }}"
...
/interface/wireguard/peers/add allowed-address=192.168.89.5/32 interface=wg-management name=bfiola-desktop-wsl-management persistent-keepalive=25s public-key="{{ secrets.wireguard.devices.bfiolaDesktopWsl.management.public }}"
...
/ip/dhcp-server/lease/add address=192.168.24.5 server=iot mac-address=EC:E3:34:8C:F5:58 comment="yoto player"
...
/ip/dhcp-server/lease/add address=192.168.24.10 server=iot mac-address=24:48:45:4D:1C:00 comment="front-yard.camera"
...
/ip/dns/static/add name=bedroom-2.assistant.fiola.dev address=192.168.88.14 ttl=10m
...
/ip/dns/static/add name=nas.fiola.dev address=192.168.32.7 ttl=10m
...
/ip/firewall/address-list/add list=IOT_ALLOW_WAN address=192.168.24.14 comment="bedroom-2.assistant"
...
/ip/firewall/address-list/add list=IOT_ALLOW_INTRANET address=192.168.24.14 comment="bedroom-2.assistant"
...
/ip/firewall/filter/add chain=forward action=accept in-interface-list=IOT src-address-list=IOT_ALLOW_INTRANET out-interface-list=FRIENDS comment="accept iot (allow intranet) -> friends"
...
/ip/firewall/filter/add chain=forward action=accept in-interface-list=IOT src-address-list=IOT_ALLOW_INTRANET out-interface-list=INFRASTRUCTURE dst-address-list=INFRASTRUCTURE_INGRESS_FAMILY comment="accept iot (allow intranet) -> infrastructure (family ingress)"
